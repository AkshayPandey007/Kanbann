...
const App = () => {
  ...
  const { boards, selectedBoard, loading }: any = useSelector(
    ...
    <div className='flex h-screen'>
      ...
      <main className='flex-1 p-4 overflow-auto'>
        {loading ? (
          ...
          <p className='text-gray-400 text-center mt-10'>No board selected</p>
        )}
      </main>
